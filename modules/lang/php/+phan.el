;;; lang/php/+phan.el -*- lexical-binding: t; -*-
;;; Commentary:
;;
...
(defvar flycheck-phanclient--phanclient-executable "phan_client")
...
See URL `https://github.com/phan/phan'."
  :command ("docker" "run -v $PWD:/mnt/src --rm -u $(id -u):$(id -g) --entrypoint='' cloudflare/phan:latest /opt/phan/phan_client" "-l" source-original "-f" source)
...
;;  docker run -v $PWD:/mnt/src --rm -u $(id -u):$(id -g) --entrypoint="" cloudflare/phan:latest /opt/phan/phan_client
;;  docker run -v $PWD:/mnt/src --rm -u $(id -u):$(id -g) cloudflare/phan:latest

(setq
 flycheck-phanclient--phanclient-executable "docker run -v $PWD:/mnt/src --rm -u $(id -u):$(id -g) --entrypoint='' cloudflare/phan:latest /opt/phan/phan_client"
 flycheck-phanclient--phan-executable "docker run -v $PWD:/mnt/src --rm -u $(id -u):$(id -g) -p 4846:4846 cloudflare/phan:latest")
